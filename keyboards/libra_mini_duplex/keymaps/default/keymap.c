...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_default(
        ...
        KC_TRNS, KC_TRNS, JM_SPI , JM_SPD , JM_IGI , JM_IGD ,         KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN5, KC_BTN4, KC_BTN3, KC_TRNS,
    ...
    [3] = LAYOUT_default(
        ...
        KC_TRNS, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI,         KC_SPAM, JS_TOGG, DB_TOGG, DT_UP  , DT_DOWN, DT_PRNT, KC_TRNS,
