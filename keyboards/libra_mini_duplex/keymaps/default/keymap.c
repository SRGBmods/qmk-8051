...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_default(
		...
		KC_TAB,         KC_A, KC_S, KC_D, KC_F, KC_G,                     KC_H, KC_J, KC_K, KC_L, KC_SCLN,     KC_QUOT, 
		   KC_LCTL,       KC_Z, KC_X, KC_C, KC_V, KC_B,               KC_MINS, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, MO(3), 
		KC_LSFT, KC_LGUI,     KC_LALT, LSFT_T(KC_SPC),                LT(1,KC_BSPC), RCTL_T(KC_ENT),   JS_PD,   KC_BTN1, LT(2,KC_BTN2),
		                                                                                        KC_NO, KC_NO, KC_NO),
    [1] = LAYOUT_default(
    ...
    [3] = LAYOUT_default(
        ...
        KC_TRNS, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI,         KC_SPAM, JS_TOGG, QK_BOOT, DB_TOGG, AG_LNRM, KC_TRNS, KC_TRNS,
...
uint32_t spam_interval = 30000; // (1000ms == 1s)
